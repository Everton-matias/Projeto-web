  ...
  return (
    <div className="flex w-full min-h-screen">
      ...
      <div className="flex-1 bg-green-700 flex flex-col items-center justify-center px-10 py-12">
        ...
        <h1 className="text-white text-3xl font-black tracking-widest mb-1">
          NOT FAT
        </h1>
        <p className="text-white/75 text-sm italic mb-10">
      ...
      <div className="flex-1 bg-neutral-900 flex flex-col items-center justify-center px-10 py-12">
        ...
        <button className="flex items-center justify-center gap-3 w-full max-w-xs py-3 px-6 rounded-xl border border-white/20 bg-transparent text-white text-sm font-semibold cursor-pointer hover:bg-white/10 transition-all">
          <svg
            width="20"
            height="20"
            viewBox="0 0 48 48"
