  ...
  return (
    <div className="max-w-[1400px] ml-auto">
      <div className="flex-1 h-screen bg-[#121212] text-gray-200 overflow-y-auto p-8 font-sans">
        ...
        {/* Cabeçalho */}
        <div className="flex items-center gap-2 mb-8 cursor-pointer hover:text-white transition-colors">
        ...
        <div className="max-w-4xl bg-[#1A1A1A] mt-45 ml-60 border border-white/5 rounded-2xl p-8 shadow-lg">
          ...
          {/* Input Nome */}
            ...
            <h4 className="text-sm font-semibold text-gray-400 mb-4 tracking-wider">DADOS PESSOAIS</h4>
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-[#242424] rounded-lg p-3 border border-white/5 focus-within:border-white/20 transition-colors h-[72px] flex flex-col justify-center">
              ...
              <label htmlFor="input-nome" className="block text-xs text-gray-400 mb-1 cursor-pointer hover:text-gray-300">
                Nome completo
              </label>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 ml-1">Não pode ser alterado</p>
              </div>
            </div>
          </div>
